 ...
 * <br/>
 * Evaluates the worth of a set attributes by measuring the symmetrical
 * uncertainty with respect to another set of attributes. <br/>
 * <br/>
 * SymmU(AttributeSet2, AttributeSet1) = 2 * (H(AttributeSet2) - H(AttributeSet1
 * | AttributeSet2)) / H(AttributeSet2) + H(AttributeSet1).<br/>
 * <br/>
...
public class SymmetricalUncertAttributeSetEval
   ...
   *
    ...
    /**
     * Initializes a symmetrical uncertainty attribute evaluator. Discretizes
     * all attributes that are numeric.
     *
     ...
     * @param classAttributes the indexes of the attributes whose combination
     * will be used as class label
     * @return the uncertainty
     * @throws Exception if the attribute could not be evaluated
     */
